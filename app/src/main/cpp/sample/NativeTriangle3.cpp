...
static GLfloat color[3 * VERTEX_COLOR_SIZE] = {
...
void NativeTriangle3::Draw() {
    ...
    if (vboIds[0] == 0 && vboIds[1] == 0 && vboIds[2] == 0) {
        ...
        */
        glBufferData(GL_ARRAY_BUFFER, VERTEX_POS_SIZE * sizeof(GLfloat) * 3, vertexPos, GL_STATIC_DRAW);
        // VBO 1 是 缓冲 颜色
        glBindBuffer(GL_ARRAY_BUFFER, vboIds[1]);
        glBufferData(GL_ARRAY_BUFFER, VERTEX_COLOR_SIZE * sizeof(GLfloat) * 3, color, GL_STATIC_DRAW);
   ...
   */
    //设置顶点属性指针
    glVertexAttribPointer(VERTEX_POS_INDEX, VERTEX_POS_SIZE, GL_FLOAT, GL_FALSE, VERTEX_POS_SIZE * sizeof(GLfloat), nullptr);

    glBindBuffer(GL_ARRAY_BUFFER, vboIds[1]);
    glEnableVertexAttribArray(VERTEX_COLOR_INDEX);
    glVertexAttribPointer(VERTEX_COLOR_INDEX, VERTEX_COLOR_SIZE, GL_FLOAT, GL_FALSE, VERTEX_COLOR_SIZE * sizeof(GLfloat), nullptr);
